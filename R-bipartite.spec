...
Version  : 2.21
Release  : 62
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/bipartite_2.21.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/bipartite_2.21.tar.gz
...
%setup -q -n bipartite
pushd ..
cp -a bipartite buildavx2
popd
pushd ..
cp -a bipartite buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740156246
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/bipartite/libs/bipartite.so
/V4/usr/lib64/R/library/bipartite/libs/bipartite.so
