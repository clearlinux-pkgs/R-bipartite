...
Version  : 2.19
Release  : 59
URL      : https://cran.r-project.org/src/contrib/bipartite_2.19.tar.gz
Source0  : https://cran.r-project.org/src/contrib/bipartite_2.19.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701724966
