...
Version  : 2.18
Release  : 53
URL      : https://cran.r-project.org/src/contrib/bipartite_2.18.tar.gz
Source0  : https://cran.r-project.org/src/contrib/bipartite_2.18.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666195049
